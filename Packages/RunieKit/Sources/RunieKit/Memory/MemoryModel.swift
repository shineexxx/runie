...
/// оперативную целиком, система подтягивает нужные строки сама. Числа в ней
/// половинной точности: Runie собирается только под Apple Silicon, где такой
/// тип есть в самом языке.
